...
These write-ups describe the static page, its event model, and the calendar
export path. [`measurement.md`](measurement.md) records the commands behind the
numbers and screenshots in the overview.

| Component | Focus |
|---|---|
| [Application shell](app-shell.md) | Page structure, load order, and visible controls. |
